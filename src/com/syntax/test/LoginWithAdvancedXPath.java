...
public class LoginWithAdvancedXPath extends CommonMethods {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//identify login based on first parents previous sibling(uncle)
...
//		click(loginBtn);
		...
		WebElement loginBtn=driver.findElement(By.xpath("//form[@id='frmLogin']/div[5]/input")); //(i am the grandson of my grandparents 5th son
		click(loginBtn);
